...
-- Dumping data for table logistic_system.package: ~1 rows (approximately)
...
INSERT INTO `package` (`pkg_id`, `created_datetime`, `size`, `weight`, `tracking_status`, `isreturn`, `delivery_fee`, `cod_value`, `receiver_name`, `receiver_phone_num`, `receiver_address`, `sender_name`, `sender_phone_num`, `sender_address`, `current_hub`, `current_shipper`, `current_driver`, `next_hub`, `pick_time`, `drop_time`) VALUES
	('P001', '2021-07-23 10:39:01', 'vSmall', 2, 'new-picking(37)-picked(37)-inhub(HoChiMinh)-sending(22)-arriving(22)-arrived(22)-inhub(LamDong)-sending(20)-arriving(20)-arrived(20)-inhub(DaNang)-delivering(33)-delivered(33)', b'0', 10000, 0, 'Nguyen Thi Bug', '987654321', 'Province: KhanhHoa District: 1', 'Tran Van Fix', '123456789', 'Province: TayNinh District: 1', '-1', -1, -1, 'final', '2021-07-23 10:49:04', '2021-07-23 10:56:43');
...
-- Dumping data for table logistic_system.route: ~2 rows (approximately)
/*!40000 ALTER TABLE `route` DISABLE KEYS */;
INSERT INTO `route` (`route_id`, `driver_id`, `start_pos`, `end_pos`, `start_datetime`, `end_datetime`) VALUES
	('HoChiMinh-LamDong-20210723T105020', 22, 'HoChiMinh', 'LamDong', '2021-07-23 10:50:20', '2021-07-23 10:52:10'),
	('LamDong-DaNang-20210723T105248', 20, 'LamDong', 'DaNang', '2021-07-23 10:52:48', '2021-07-23 10:55:07');
...
CREATE TABLE IF NOT EXISTS `route_detail` (
  ...
  CONSTRAINT `FK_route_detail_route` FOREIGN KEY (`route_id`) REFERENCES `route` (`route_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Dumping data for table logistic_system.route_detail: ~2 rows (approximately)
/*!40000 ALTER TABLE `route_detail` DISABLE KEYS */;
INSERT INTO `route_detail` (`pkg_id`, `route_id`) VALUES
	('P001', 'HoChiMinh-LamDong-20210723T105020'),
	('P001', 'LamDong-DaNang-20210723T105248');
...
-- Dumping data for table logistic_system.ship_route: ~2 rows (approximately)
/*!40000 ALTER TABLE `ship_route` DISABLE KEYS */;
INSERT INTO `ship_route` (`ship_route_id`, `shipper_id`, `date`, `end_time`) VALUES
	('ShipperStaff1320210723T104438', 37, '2021-07-23', '2021-07-23 10:49:58'),
	('ShipperStaff920210723T105529', 33, '2021-07-23', NULL);
...
CREATE TABLE IF NOT EXISTS `ship_route_detail` (
  ...
  CONSTRAINT `FK__package1` FOREIGN KEY (`pkg_id`) REFERENCES `package` (`pkg_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- Dumping data for table logistic_system.ship_route_detail: ~2 rows (approximately)
/*!40000 ALTER TABLE `ship_route_detail` DISABLE KEYS */;
INSERT INTO `ship_route_detail` (`ship_route_id`, `pkg_id`) VALUES
	('ShipperStaff1320210723T104438', 'P001'),
	('ShipperStaff920210723T105529', 'P001');
